...
def SQL_Init_String(str):
    query_string = """
        ...
        CREATE TABLE IF NOT EXISTS networking(networking_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, aquaintance_name_and_title TINYTEXT, company_name TINYTEXT, contact_information TINYTEXT, comments TEXT);
